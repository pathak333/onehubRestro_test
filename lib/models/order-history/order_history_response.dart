...
OrderHistoryListResponse orderHistoryListResponseFromJson(String str) =>
    OrderHistoryListResponse.fromJson(json.decode(str));

String orderHistoryListResponseToJson(OrderHistoryListResponse data) =>
...
class OrderHistoryListResult {
  ...
  factory OrderHistoryListResult.fromJson(Map<String, dynamic> json) =>
      OrderHistoryListResult(
